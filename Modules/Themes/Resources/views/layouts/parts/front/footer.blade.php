<footer class="site-footer footer-light">
    ...
    <!--div class="section-full overlay-wraper bg-primary" style="background-image:url({{ asset('storage/images/background/bg-7.png') }});">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="widget widget_about">
                        ...
                        <div class="logo-footer clearfix p-b15">
                            <a href="index.html"><img src="{{ asset('storage/images/logo.png') }}" width="230" height="67" alt=""/></a>
                        </div>
