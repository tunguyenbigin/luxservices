...
@section('styles')
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('storage/app-assets/css/pages/chat-application.css') }}">
@stop

@section('content')
	<div class="sidebar-left sidebar-fixed ps-container ps-theme-dark">
		<div class="sidebar">
						...
						<a href="#" class="media border-0">
							<div class="media-left pr-1">
								<span class="avatar avatar-md avatar-online">
									<img class="media-object rounded-circle" src="https://pixinvent.com/modern-admin-clean-bootstrap-4-dashboard-html-template/app-assets/images/portrait/small/avatar-s-8.png" alt="Generic placeholder image">
									<i></i>
								</span>
							</div>
							...
							<div class="chat">
								<div class="chat-avatar">
									<a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
										<img src="https://pixinvent.com/modern-admin-clean-bootstrap-4-dashboard-html-template/app-assets/images/portrait/small/avatar-s-8.png" alt="avatar">
									</a>
								</div>
								<div class="chat-body">
...
@section('scripts')
	<script type="text/javascript" src="{{ asset('storage/app-assets/js/scripts/pages/chat-application.js') }}"></script>
@stop