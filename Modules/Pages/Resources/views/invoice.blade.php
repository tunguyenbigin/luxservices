...
@section('styles')
	<link rel="stylesheet" type="text/css" href="{{ asset('storage/app-assets/css/pages/invoice.min.css') }}">
@stop

@section('content')
<div class="content-header row">
	<div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
		<h3 class="content-header-title mb-0 d-inline-block">Invoices #INV-001</h3>
		...
		<div id="invoice-template" class="card-body">
			...
			<div id="invoice-company-details" class="row">
				<div class="col-md-6 col-sm-12 text-center text-md-left">
					<div class="media">
						<img src="https://pixinvent.com/modern-admin-clean-bootstrap-4-dashboard-html-template/app-assets/images/logo/logo-80x80.png" alt="company logo" class="">
							...
							<div class="row">
								...
								<div class="col-md-5 col-sm-12">
									...
									<div class="text-center">
										...
										<img src="https://pixinvent.com/modern-admin-clean-bootstrap-4-dashboard-html-template/app-assets/images/pages/signature-scan.png" alt="signature" class="height-100">
										<h6>Amanda Orton</h6>
